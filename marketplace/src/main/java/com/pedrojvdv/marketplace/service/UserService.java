...
import com.pedrojvdv.marketplace.dto.UserDto;
...
public class UserService {
    ...
    public Optional<UserEntity> getUserByRole(Role role) throws NotFoundException {
        Optional<UserEntity> user = userRepository.findByRole(role);
        if (user.isEmpty()) {
